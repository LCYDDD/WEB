...
public class AdminController {
    ...
    public String addStudent(StudentCustom studentCustom, Model model) throws Exception {
        ...
        selectedCourseCustom.setCourseid(0);
        selectedCourseCustom.setStudentid(studentCustom.getUserid());
    ...
    public String addCourse(CourseCustom courseCustom, Model model) throws Exception {
        ...
        if (!result) {
            model.addAttribute("message", "课程号重复或时间冲突或者地点冲突");
            return "error";
        }
